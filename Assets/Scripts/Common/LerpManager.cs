...
public class LerpManager : Singleton<LerpManager>
{
    ...
    private static IEnumerator LoopWaitRoutine<T>(T[] array, float timeBetweenElements, System.Action<T> elementAction, System.Action finishedAction = null)
    {
    ...
    public static void LoopWait(int arrayLength, float timeBetweenElements, System.Action<int> elementAction, System.Action finishedAction = null)
    {
        Instance.StartCoroutine(LoopWaitRoutine(arrayLength, timeBetweenElements, elementAction, finishedAction));
    }

    private static IEnumerator LoopWaitRoutine(int arrayLength, float timeBetweenElements, System.Action<int> elementAction, System.Action finishedAction = null)
    {
